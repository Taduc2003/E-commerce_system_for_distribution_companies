...
const Profile = () => {
  const { user, staff, uploadAvatar, updateUserProfile } = useContext(UserContext);
          ...
          {isEditing ? (
            ...
            <div className='space-y-6'>
                ...
                <div>
                  ...
                  <span className='inline-block px-3 py-1 bg-gray-100 text-gray-800 text-sm rounded-full'>
                    {(() => {
                      ...
                      return roleNames[user.role?.roleName] || user.role?.roleName || 'Chưa xác định';
                    })()}
                  </span>
                </div>
              </div>

              {/* User ID và Branch Info */}
              <div className='border-t pt-4 space-y-4'>
                ...
                {/* ✅ Chỉ hiển thị thông tin chi nhánh khi staff != null */}
                {staff && (
                  <div>
                    <label className='block text-sm font-medium text-gray-500 mb-1'>
                      Thông tin chi nhánh
                    ...
                    {staff.branch ? (
                      <div className='bg-blue-50 p-4 rounded-lg border border-blue-200'>
                        <div className='space-y-2 flex flex-col'>
                          <span className='text-sm font-medium text-gray-800'>Chi nhánh: #{staff.branch.branchId}</span>
                          <span className='text-sm font-medium text-gray-800'>Địa chỉ: {staff.branch.address}</span>
                          <span className='text-sm font-medium text-gray-800'>Số điện thoại: {staff.branch.phone}</span>
                        </div>
                      </div>
                    ) : (
                      <div className='bg-gray-50 p-4 rounded-lg border border-gray-200'>
                        <p className='text-gray-600'>Chưa được phân công chi nhánh</p>
                      </div>
                    )}
                  </div>
                )}
